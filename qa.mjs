...
try {
  ...
  w.SITE_DATA?.appVersion === "0.46.0" ? pass("Version 0.46.0") : fail("Version mismatch");
...
html404.includes("style.css?v=0.46.0") ? pass("404 cache version") : fail("404 cache version mismatch");
