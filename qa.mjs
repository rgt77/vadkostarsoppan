...
try {
  ...
  w.SITE_DATA?.appVersion === "0.44.1" ? pass("Version 0.44.1") : fail("Version mismatch");
...
html404.includes("style.css?v=0.44.1") ? pass("404 cache version") : fail("404 cache version mismatch");
