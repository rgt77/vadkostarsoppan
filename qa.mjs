...
try {
  ...
  w.SITE_DATA?.appVersion === "0.45.1" ? pass("Version 0.45.1") : fail("Version mismatch");
...
html404.includes("style.css?v=0.45.1") ? pass("404 cache version") : fail("404 cache version mismatch");
